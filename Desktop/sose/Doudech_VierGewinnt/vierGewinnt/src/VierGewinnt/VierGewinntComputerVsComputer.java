...
public class VierGewinntComputerVsComputer extends RegularControl<Pair<Byte, Byte>>
{
...
static int i =1; 
    ...
    //Konstruktor
    VierGewinntComputerVsComputer(VierGewinnt b)
    {
        super(b);
    }
...
@Override
    public void whenMousePressed(byte r,byte c){
     ...
     if ((i%2 == 0) && (!board.getGame().endedGame())){
       ...
       if( Utils.getInstance().getC1Mode() == "C1MM"){
           ...
           board.setGame((VierGewinnt)ki.doBestMove(board.getGame()));   
     }else if (Utils.getInstance().getC1Mode() == "C1AB"){
         board.setGame((VierGewinnt)ki2.doBestMove(board.getGame()));   
         
     }
     else if(Utils.getInstance().getC1Mode() == "C1B"){
         board.setGame((VierGewinnt)ki3.doBestMove(board.getGame()));
    ...
    {
         Utils.getInstance().setC2Mode("C2AB");
         Utils.getInstance().setC1Mode("C1MM");
